...
! function(e, t) {
   ...
   var r = 1,
       ...
       a = {
           ...
           dasherize: function(e) {
               return e.replace(/::/g, "https://coderthemes.com/").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z\d])([A-Z])/g, "$1_$2").replace(/_/g, "-").toLowerCase()
           },
           warn: function() {
               var e;
   ...
   e.extend(!0, T, {
       ...
       type: {
           ...
           url: "URL tidak valid.",
           number: "Bagian ini harus berupa angka/numeric",
           integer: "This value should be a valid integer.",
           digits: "This value should be digits.",
           alphanum: "Nama tersebut tidak di izin kan. \n perhatikan bahwa kami hanya mengizinkan nama sesuai dengan ketentuan. <a href='https://nav-pedia.co.id/term/?seid=no122'> baca disini</a> "
       },
       ...
       range: "Nomor tidak valid, isi harus di antara %s & %s.",
